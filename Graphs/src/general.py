...
class Node:
    def __init__(self, value) -> None:
        """
        Create a node of a hashable type object.
        """
        self.__value = value
...
class Graph(ABC):
    ...
    def full(self) -> bool:
        """
        Check whether the graph is full.
        """
        pass
    ...
    def isomorphic_bijection(self, other: "Graph") -> dict[Node, Node]:
        ...
        Return an isomorphic function between the nodes of the graph and
        those of the given graph, if such exists, otherwise empty dictionary.
        """
        pass
