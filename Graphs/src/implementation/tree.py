...
from Personal.Graphs.src.implementation.directed_graph import DirectedGraph, WeightedNodesDirectedGraph

from Personal.Graphs.src.implementation.undirected_graph import Node, UndirectedGraph, WeightedNodesUndirectedGraph
...
class Tree:
    ...
    def parent(self, u: Node = None) -> dict[Node, Node] | Node:
        return self.__parent.copy() if u is None else self.__parent[u]
