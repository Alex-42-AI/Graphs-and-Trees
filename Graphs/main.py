...
if __name__ == "__main__":
    ...
    with open("src/morse_code.txt", "w", encoding="utf-8") as file:
    ...
    with open("src/k_3_3.txt", "w") as file:
        file.write(f"{k_3_3}\n")
    ...
    with open("src/k_5.txt", "w") as file:
        file.write(f"{k_5}\n")
    ...
    with open("src/petersen_graph.txt", "w") as file:
    ...
    with open("src/undirected_graphs.txt", "w", encoding="utf-8") as file:
    ...
    with open("src/tree.txt", "w", encoding="utf-8") as file:
        file.write(f"{tree}\n")
    ...
    with open("src/directed_graphs.txt", "w") as file:
