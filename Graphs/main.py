...
g0 = UndirectedGraph({n1: [n0, n2, n3], n2: [n0, n3], n4: [n3, n5, n6, n7, n8, n9, n10], n5: [n6], n8: [n7, n9], n10: [n9, n11, n12, n13, n14], n13: [n14, n15]})
g1 = UndirectedGraph({n0: [n1, n2], n2: [n1, n3, n4], n4: [n3, n5], n5: [n6, n7, n8], n6: [n7, n8], n7: [n8, n9]})
g2 = UndirectedGraph({n0: [n1, n2, n3, n4, n5]})
g3 = UndirectedGraph({n1: [n0, n2, n3, n4, n5, n6, n8], n2: [n0, n3, n4, n5, n6, n7, n8], n8: [n6, n7, n9, n10]})
g4 = UndirectedGraph({n1: [n0, n2, n3, n4, n5, n7], n2: [n0, n3, n4, n5, n6, n7], n7: [n6, n8, n9]})
...
with open("Undirected graphs.txt", "w", encoding="utf-8") as file:
    ...
    file.write(f"Is graph 3 a tree: {g0.is_tree()}\nIs graph 4 a tree: {g1.is_tree()}\n")
    file.write(f"Is graph 5 a tree: {g2.is_tree()}\nIs graph 6 a tree: {g3.is_tree()}\n")
    file.write(f"Is graph 7 a tree: {g4.is_tree()}\n")
    ...
    file.write(f"Graph 3 cut nodes: {g0.cut_nodes()}\nGraph 3 bridge links: {g0.bridge_links()}\n")
    file.write(f"Graph 4 cut nodes: {g1.cut_nodes()}\nGraph 4 bridge links: {g1.bridge_links()}\n")
    file.write(f"Graph 6 cut nodes: {g3.cut_nodes()}\nGraph 6 bridge links: {g3.bridge_links()}\n")
    file.write(f"Graph 7 cut nodes: {g4.cut_nodes()}\nGraph 7 bridge links: {g4.bridge_links()}\n")
    ...
    file.write(f"3-cliques in graph 1: {ug0.cliques(3)}\n3-cliques in graph 3: {g0.cliques(3)}\n")
    file.write(f"3-cliques in graph 4: {g1.cliques(3)}\n4-cliques in graph 4: {g1.cliques(4)}\n")
    file.write(f"3-cliques in graph 6: {g3.cliques(3)}\n4-cliques in graph 6: {g3.cliques(4)}\n")
    file.write(f"3-cliques in graph 7: {g4.cliques(3)}\n")
    file.write(f"Graph 3 interval sort: {g0.interval_sort()}\n")
    file.write(f"Graph 4 interval sort: {g1.interval_sort()}\n")
    file.write(f"Graph 5 interval sort: {g2.interval_sort()}\n")
    file.write(f"Graph 6 interval sort: {g3.interval_sort()}\n")
    file.write(f"Graph 7 interval sort: {g4.interval_sort()}\n")
    ...
    file.write(f"Chromatic nodes partition of graph 3: {g0.chromatic_nodes_partition()}\n")
    file.write(f"Chromatic nodes partition of graph 4: {g1.chromatic_nodes_partition()}\n")
    file.write(f"Chromatic nodes partition of graph 5: {g2.chromatic_nodes_partition()}\n")
    file.write(f"Chromatic nodes partition of graph 6: {g3.chromatic_nodes_partition()}\n")
    file.write(f"Chromatic nodes partition of graph 7: {g4.chromatic_nodes_partition()}\n")
    ...
    file.write(f"Graph 3 optimal vertex cover: {g0.vertex_cover()}\n")
    file.write(f"Graph 3 optimal dominating set: {g0.dominating_set()}\n")
    file.write(f"Graph 3 optimal independent set: {g0.independent_set()}\n")
    file.write(f"Graph 4 optimal vertex cover: {g1.vertex_cover()}\n")
    file.write(f"Graph 4 optimal dominating set: {g1.dominating_set()}\n")
    file.write(f"Graph 4 optimal independent set: {g1.independent_set()}\n")
    file.write(f"Graph 5 optimal vertex cover: {g2.vertex_cover()}\n")
    file.write(f"Graph 5 optimal dominating set: {g2.dominating_set()}\n")
    file.write(f"Graph 5 optimal independent set: {g2.independent_set()}\n")
    file.write(f"Graph 6 optimal vertex cover: {g3.vertex_cover()}\n")
    file.write(f"Graph 6 optimal dominating set: {g3.dominating_set()}\n")
    file.write(f"Graph 6 optimal independent set: {g3.independent_set()}\n")
    file.write(f"Graph 7 optimal vertex cover: {g4.vertex_cover()}\n")
    file.write(f"Graph 7 optimal dominating set: {g4.dominating_set()}\n")
    file.write(f"Graph 7 optimal independent set: {g4.independent_set()}\n")
