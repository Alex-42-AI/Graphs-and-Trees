...
with open("K_3_3.txt", "w") as file:
    ...
    file.write(f"Chromatic links partition: {k_3_3.chromaticNumberLinks()}\n")
...
with open("Peterson graph.txt", "w") as file:
    ...
    file.write(f"Chromatic links partition: {peterson_graph.chromaticNumberLinks()}\n")
...
with open("Undirected graphs.txt", "w") as file:
    ...
    file.write(f"Chromatic nodes partition of graph 1: {ug0.chromaticNumberNodes()}\n")
    file.write(f"Chromatic links partition of graph 1: {ug0.chromaticNumberLinks()}\n")
    file.write(f"Chromatic nodes partition of graph 2: {ug1.chromaticNumberNodes()}\n")
    file.write(f"Chromatic links partition of graph 2: {ug1.chromaticNumberNodes()}\n")
