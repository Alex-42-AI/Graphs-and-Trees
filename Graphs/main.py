...
with open("Peterson graph.txt", "w") as file:
    ...
    file.write(f"Chromatic nodes partition: {peterson_graph.chromaticNodesPartition()}\n")
    file.write(f"Chromatic links partition: {peterson_graph.chromaticLinksPartition()}\n")
