...
class MultiGraph(ABC):
    """
    Abstract base class for multi-graphs.
    """
    ...
    @abstractmethod
    def links(self) -> dict["Link" | tuple[Node, Node], int]:
        """
        Returns:
            Graph links.
        """
    ...
    @abstractmethod
    def remove(self, n: Node, *rest: Node) -> "MultiGraph":
        """
        Remove a non-empty set of nodes.
        Args:
            n: First given node.
    ...
    @abstractmethod
    def connect_all(self, u: Node, *rest: Node) -> "MultiGraph":
        """
        Args:
            u: Node object.
            rest: Node objects.
    ...
    @abstractmethod
    def disconnect_all(self, u: Node, *rest: Node) -> "MultiGraph":
        """
        Args:
            u: First given node.
            rest: Other given nodes.
    ...
    @abstractmethod
    def non_multi_graph(self) -> Graph:
        """
        Returns:
            The non multi-graph version of the graph.
        """
        pass

    @abstractmethod
    def component(self, u: Node) -> "MultiGraph":
        pass

    @abstractmethod
    def subgraph(self, u_or_s: Node | Iterable[Node]) -> "MultiGraph":
        """
        Args:
            u_or_s: Given node or set of nodes.
        Returns:
    ...
    @abstractmethod
    def connection_components(self) -> list["MultiGraph"]:
        """
        Returns:
            A list of all connection components of the graph.
        """
    ...
    @abstractmethod
    def weighted_nodes_graph(self, weights: dict[Node, float] = None) -> "MultiGraph":
        """
        Args:
            weights: A dictionary, mapping nodes to their weights.
        Returns:
    ...
    @abstractmethod
    def isomorphic_bijection(self, other: "MultiGraph") -> dict[Node, Node]:
        """
        Args:
            other: another Graph object
        Returns:
    ...
    @abstractmethod
    def __add__(self, other: "MultiGraph") -> "MultiGraph":
        pass

    @abstractmethod
    def __eq__(self, other: "MultiGraph"):
        """
        Args:
            other: another Graph object
        Returns:
